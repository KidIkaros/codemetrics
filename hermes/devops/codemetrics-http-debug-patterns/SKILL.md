...
description: Debugging patterns for embedding CodeMetrics CLI tools into in-process HTTP servers — payload field mismatches, status code misrouting, metrics handler omissions, and script path overrides
version: 1.1.0
author: Hermes Agent
license: OPL-1.1
metadata:
...
- `crates/codemetrics-server/src/main.rs` — HTTP handlers, metrics, batch orchestration
